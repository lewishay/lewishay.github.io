...
if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) {
    ...
    // Set height to 76% of browser window height (excluding toolbars etc), then calc width based on that to maintain 16:9 resolution
    var canvasHeight = window.innerHeight * 0.76;
